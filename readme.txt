	...
	Once you've created your trainers and made a starter choice, you have 7 options:
		#0 Save - If you've just created your trainers, this saves them. If you don't want to loose progress it saves it.
	Just a save. Doesn't end the game.
    ...
    which depends on it's defense and can only be chosen if it doesn't already have a shield active and if it's not on cooldown.
    ...
    Once a fight has come to an end to winner gets money from the loser. (300 $ normally, 450 for running away)
        #2 Cichcenter and cichbox - here you can restore your cichnamons HP and move charge or not, if you dare.
	Also you can store your cichnamon here, if you have more than one. 
	Plus any cichnamon that you catch with 6 cichnamon already on yourself will automatically transfer here.
